...
**Public extract:** 8,617 rows · **Live catalog:** 8,616 domains
...
| ----------------------- | ------------------------------------------------ |
| 8,617-row public sample | 8,616 live domains                               |
...
> Unique Domains. *Available .DIRECTORY One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
