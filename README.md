...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C618%20rows-8250df">
...
**Public extract:** 8,618 rows · **Live catalog:** 8,616 domains
...
- `directory.csv` — public CSV extract (8,618 rows)
- `directory.json` — public JSON extract (8,618 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,618-row public sample | 8,616 live domains                               |
